===============================================
    ...
    Copyright (c) 2003-6 Lennart Lopin. 
...
This program was successfully tested on Windows xP / .NET 1.1



IMPORTANT:

Version 0.9.2 comes with quite a rudimentary English 
memory file which you are free to use and to enlarge. This file 
(usually named "mind.mdu") will load automatically.
This standard Prelude@# version allows you to load and save other *.mdu files...

See the download section on Prelude's project site
...
+ Speech: In addition to TTS (text to speech) 
	Prelude@# now supports speech recognition! Based
	on Microsoft's SAPI 5.1 (speech API) you can train
	a "voice profile" for the software to understand your
	pronounciation and do not need to type if you want to
	converse with Prelude@#!
+ Agent: Some enhancements on the msagent handling - like
	loading the most recent msagent automatically on
	program startup.
...
Well, if you startup your Prelude@# bot 
you will find it somewhat stupid and dumb -
However, do not despair! 
Although the first few minutes can be daring it
...
Just send an email to lenni_lop@yahoo.de or better
even: post a message on our message board

http://prelude.lennart-lopin.de/board/index.php
